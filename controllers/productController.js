...
getProducts = (req, res, next) => {
    ...
    Product.fetchAll((products) => {
        ...
        res.render('shop/product-list', {products, pageTitle:'Shop', activePath: "/"}); //Render the shop view. Its path and format is already mentioned in the app.js configuration
    });
